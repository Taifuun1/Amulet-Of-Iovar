...
var aquaticLife = preload("res://Objects/Critter/Aquatic life/AquaticLife.gd").new()
...
var floatingSpheres = preload("res://Objects/Critter/Floating spheres/FloatingSpheres.gd").new()
var giants = preload("res://Objects/Critter/Giants/Giants.gd").new()
var humans = preload("res://Objects/Critter/Humans/Humans.gd").new()
var iovarsCultists = preload("res://Objects/Critter/Iovars cultists/IovarsCultists.gd").new()
